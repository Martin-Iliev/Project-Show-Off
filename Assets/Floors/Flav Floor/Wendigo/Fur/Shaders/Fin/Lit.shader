...
Properties
{
    ...
    [HideInInspector]_NormalScale("Normal Scale", Range(0.0, 2.0)) = 0.0
    ...
    [HideInInspector]_FaceViewProdThresh("Direction Threshold", Range(0.0, 1.0)) = 0.1
    [HideInInspector]_Occlusion("Occlusion", Range(0.0, 1.0)) = 0.3
    ...
    [HideInInspector]_TessMinDist("Tesselation Min Distance", Range(0.1, 50)) = 1.0
    [HideInInspector]_TessMaxDist("Tesselation Max Distance", Range(0.1, 50)) = 10.0
    _TessFactor("Tessellation Factor", Range(1, 10)) = 5

    //[Header(Lighting)][Space]
    [HideInInspector]_RimLightPower("Rim Light Power", Range(1.0, 20.0)) = 6.0
    [HideInInspector]_RimLightIntensity("Rim Light Intensity", Range(0.0, 1.0)) = 0.5
    [HideInInspector]_ShadowExtraBias("Shadow Extra Bias", Range(-1.0, 1.0)) = 0.0
}
